...
const LeadSchema = new mongoose.Schema(
  {
    ...
    followupHistory: [{
      ...
      lastContactDate: { type: Date },
      nextFollowupDate: { type: Date },
      status: { type: String, enum: ['planned', 'completed', 'cancelled', 'rescheduled', 'skipped', 'missed'], default: 'planned' },
      followupType: { type: String, enum: ['Call', 'Meeting', 'Email', 'WhatsApp', 'Task', 'Demo'], default: 'Call' },
