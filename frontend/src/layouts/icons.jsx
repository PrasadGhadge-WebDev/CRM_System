export function Icon({ name, size = 18 }) {
  ...
  switch (name) {
    ...
    case 'wallet':
      return (
        <svg {...common} aria-hidden="true">
          <path {...stroke} d="M20 12V8H6a2 2 0 0 1-2-2c0-1.1.9-2 2-2h12v4" />
          <path {...stroke} d="M4 6v12c0 1.1.9 2 2 2h14v-4" />
          <path {...stroke} d="M18 12a2 2 0 0 0-2 2c0 1.1.9 2 2 2h4v-4h-4z" />
        </svg>
      )
    case 'briefcase':
      return (
    ...
    case 'dollar-sign':
      return (
        <svg {...common} aria-hidden="true">
          <line {...stroke} x1="12" y1="1" x2="12" y2="23" />
